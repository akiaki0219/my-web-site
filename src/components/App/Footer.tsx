      ...
      <div className="hidden md:flex">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <div className="flex">
            ...
            <a className="px-8 py-2 my-1 hover:bg-gray-600 rounded" href="http://www.youtube.com/@akiaki02_19" target="_blank">YouTube</a>
            <a className="px-8 py-2 my-1 hover:bg-gray-600 rounded" href="https://www.nicovideo.jp/user/130487990" target="_blank">niconico</a>
      ...
      <div className="flex md:hidden">
        <div className="container mx-auto text-center items-center">
          ...
          <div className="flex justify-center">
            ...
            <a className="px-8 py-2 my-1 hover:bg-gray-600 rounded" href="http://www.youtube.com/@akiaki02_19" target="_blank">
              <svg className="h-6 w-6 fill-none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <path d="M22.54 6.42a2.78 2.78 0 0 0-1.94-2C18.88 4 12 4 12 4s-6.88 0-8.6.46a2.78 2.78 0 0 0-1.94 2A29 29 0 0 0 1 11.75a29 29 0 0 0 .46 5.33A2.78 2.78 0 0 0 3.4 19c1.72.46 8.6.46 8.6.46s6.88 0 8.6-.46a2.78 2.78 0 0 0 1.94-2 29 29 0 0 0 .46-5.25 29 29 0 0 0-.46-5.33z" /> 
                <polygon points="9.75 15.02 15.5 11.75 9.75 8.48 9.75 15.02" />
              </svg>        
            </a>
            <a className="px-8 py-2 my-1 hover:bg-gray-600 rounded" href="https://www.nicovideo.jp/user/130487990" target="_blank">
              <svg className="h-6 w-6 fill-none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
